            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">Input Manufacturing Order | Done</h5>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <form action="{{ route('postprogressForm', ['id' => $order->id]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                // Ambil status availability dari database (0 atau 1)
                                                                $available = \App\Models\ManufacturingOrderBahan::where('nama_bahan', $bahan->nama_bahan)
                                                                    ->value('quantity'); // Nilai dari database
                                                        
                                                                // Tetapkan default jika tidak ada data di database
                                                                $available = $available ?? 0; 
                                                            @endphp
                                                            <select class="form-control" disabled>
                                                                <option value="1" {{ $available == 1 ? 'selected' : '' }}>✔</option>
                                                                <option value="0" {{ $available == 0 ? 'selected' : '' }}>❌</option>
                                                            </select>
