    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Draft Vendor Bill</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">Invoicing</li>
                            <li class="breadcrumb-item"><a href="{{ route('rfq.draftBills') }}">Draft Vendor Bill</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Table View -->
                                <table id="tableDraftBills" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th style="vertical-align: middle;">Reference</th>
                                            <th style="vertical-align: middle;">Vendor</th>
                                            <th style="vertical-align: middle;">Total</th>
                                            <th style="vertical-align: middle;">Status Bill</th>
