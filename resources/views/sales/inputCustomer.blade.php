...
<head>
    <title>FrojenFuud | Input Customer</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0">Input Customer</h5>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Customer</li>
                                <li class="breadcrumb-item"><a href="/Customer">Customer</a>
                                <li class="breadcrumb-item"><a href="/Customer/input">Input Data</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <form action="/Customer/post" method="POST" enctype="multipart/form-data"
                                    id="inputCustomer">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
